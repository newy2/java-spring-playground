...
> 메서드 참조는 파라미터와 리턴 타입이 동일한, 다른 이름의 FunctionalInterface(예: ToIntBiFunction, Comparator)에 할당할 수 있다. 이 규칙으로 기존의 Java API(예: Collection)에서 메서드 참조와 람다 표현식을 사용할 수 있다.
